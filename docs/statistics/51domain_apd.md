...
<img src="../docs/images/domain_input.PNG" alt="domain input" width="400" height="300" class="img-responsive">
</div>
...
<div style="text-align: center;">
<img src="../docs/images/domain_configuration.png" alt="domain configuration" width="400" height="300" class="img-responsive">
</div>
...
<div style="text-align: center;">
<img src="../docs/images/domain_output.PNG" alt="domain output" width="400" height="300" class="img-responsive">
</div>

##### Application on external set {#example}
{: .no_toc }
You can apply the generated Domain – APD model to any external data using the [`Existing Model Utilization`](https://www.docs.isalos.novamechanics.com/docs/analytics/existing-model-utilization.html) function:
...
<div style="text-align: center;">
<img src="../docs/images/domain_apply_input.PNG" alt="domain output" width="400" height="300" class="img-responsive">
</div>
...
<div style="text-align: center;">
<img src="../docs/images/domain_apply.png" alt="domain output" width="400" height="300" class="img-responsive">
</div>
...
<div style="text-align: center;">
<img src="../docs/images/domain_apply_output.PNG" alt="domain output" width="400" height="300" class="img-responsive">
</div>
---

## Tips
As calculations of Euclidean distances are performed, consider scaling the data beforehand using a [`Normalizer`](https://www.docs.isalos.novamechanics.com/docs/data_transformation/normalizers.html) function.

## See also
The model generated by the `Domain – APD` function can be applied to any input data through the [`Existing Model Utilization`](https://www.docs.isalos.novamechanics.com/docs/analytics/existing-model-utilization.html) function (e.g., to check if a test/external set of data falls within the applicability domain limits of a machine learning model, see [Example](#example)).
