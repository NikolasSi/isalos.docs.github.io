...
*   Select the column that is going to be predicted from the drop-down menu [5]. The columns containing categorical features should not be selected for prediction. 
*   Click on the `Execute` button [6] to apply the training algorithm on the input columns

<div style="text-align: center;">
<img src="images/Regression/random-forest.svg" alt="Random Forest" width="500" height="400" class="img-responsive">
</div>
...
<div style="text-align: center;">
<img src="images/Regression/random-forest-output.png" alt="Random Forest" width="500" height="400" class="img-responsive">
</div>
