...
## See also
The model generated by either the Z Score or Min-Max function can be applied to any input data through the [`Existing Model Utilization` function](https://www.docs.isalos.novamechanics.com/docs/analytics/45existing_model.html) (e.g., a scaling function tuned from the training set data of a machine learning model can be applied to the test/external set data).

### Workflows
{: .no_toc }

## References {#references-normalizers}
1. Leach AR, Gillet VJ. An introduction to chemoinformatics. 2007. [https://doi.org/10.1007/978-1-4020-6291-9](https://doi.org/10.1007/978-1-4020-6291-9).
